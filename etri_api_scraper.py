...
def main():
    ...
    parser.add_argument('--directory', type=str, default='news_dir/', help='JSON storage directory')
...
def save_txt(directory, first_index, idx, txt):
    with open(directory+'output'+str(first_index+idx), 'w', encoding='utf-8') as f:
        f.write(txt)
